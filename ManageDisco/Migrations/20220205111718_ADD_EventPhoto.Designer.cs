...
namespace ManageDisco.Migrations
{
    ...
    [Migration("20220205111718_ADD_EventPhoto")]
    partial class ADD_EventPhoto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManageDisco.Model.EventPhoto", b =>
                {
                    ...
                    b.Property<int>("EventPhotoTypeId")
                        .HasColumnType("int");

                    b.HasKey("EventPhotoId");

                    b.HasIndex("EventPhotoTypeId");

                    b.ToTable("EventPhoto");
                });

            modelBuilder.Entity("ManageDisco.Model.EventPhotoType", b =>
                {
                    b.Property<int>("EventPhotoTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("EventPhotoDescription")
                        .HasColumnType("int");

                    b.HasKey("EventPhotoTypeId");

                    b.ToTable("EventPhotoType");
                });
            ...
            modelBuilder.Entity("ManageDisco.Model.EventPhoto", b =>
                {
                    b.HasOne("ManageDisco.Model.EventPhotoType", "EventPhotoType")
                        .WithMany()
                        .HasForeignKey("EventPhotoTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EventPhotoType");
                });
