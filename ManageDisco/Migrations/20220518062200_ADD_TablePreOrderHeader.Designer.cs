...
namespace ManageDisco.Migrations
{
    ...
    [Migration("20220518062200_ADD_TablePreOrderHeader")]
    partial class ADD_TablePreOrderHeader
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManageDisco.Model.TableOrderHeader", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("TableOrderHeader");
                });
            ...
            modelBuilder.Entity("ManageDisco.Model.TablePreOrderHeader", b =>
                {
                    b.HasBaseType("ManageDisco.Model.TableOrderHeader");

                    b.Property<bool>("IsAccepted")
                        .HasColumnType("bit");

                    b.HasDiscriminator().HasValue("TablePreOrderHeader");
                });
